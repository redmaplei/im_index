! function (a, b) {
    ...
    function e(a, b) {
        var e, f, h;
        return b ? (a >>>= 0, (h = a >= 0 && 256 > a) && (f = d[a]) ? f : (e = g(a, 0 > (0 | a) ? -1 : 0, !0), h && (d[a] = e), e)) : (a |= 0, (h = a >= -128 && 128 > a) && (f = c[a]) ? f : (e = g(a, 0 > a ? -1 : 0, !1), h && (c[a] = e), e))
    }
    ...
    function i(a, b, c) {
        ...
        if ("number" == typeof b ? (c = b, b = !1) : b = !!b, c = c || 10, 2 > c || c > 36) throw RangeError("radix");
        if ((d = a.indexOf("-")) > 0) throw Error("interior hyphen");
        if (0 === d) return i(a.substring(1), b, c).neg();
        for (e = f(h(c, 8)), g = q, j = 0; j < a.length; j += 8) k = Math.min(8, a.length - j), l = parseInt(a.substring(j, j + k), c), 8 > k ? (m = f(h(c, k)), g = g.mul(m).add(f(l))) : (g = g.mul(e), g = g.add(f(l)));
    ...
    return a.prototype.__isLong__, Object.defineProperty(a.prototype, "__isLong__", {
        ...
        if (a = a || 10, 2 > a || a > 36) throw RangeError("radix");
        ...
        for (a = 0 != this.high ? this.high : this.low, b = 31; b > 0 && 0 == (a & 1 << b); b--);
        ...
        return b(a) || (a = j(a)), this.unsigned !== a.unsigned && 1 === this.high >>> 31 && 1 === a.high >>> 31 ? !1 : this.high === a.high && this.low === a.low
        ...
        for (d = this; d.gte(a);) {
            for (c = Math.max(1, Math.floor(d.toNumber() / a.toNumber())), i = Math.ceil(Math.log(c) / Math.LN2), k = 48 >= i ? 1 : h(2, i - 48), l = f(c), m = l.mul(a); m.isNegative() || m.gt(d);) c -= k, l = f(c, this.unsigned), m = l.mul(a);
        ...
        return b(a) && (a = a.toInt()), 0 === (a &= 63) ? this : 32 > a ? g(this.low << a, this.high << a | this.low >>> 32 - a, this.unsigned) : g(0, this.low << a - 32, this.unsigned)
    }, y.shl = y.shiftLeft, y.shiftRight = function (a) {
        return b(a) && (a = a.toInt()), 0 === (a &= 63) ? this : 32 > a ? g(this.low >>> a | this.high << 32 - a, this.high >> a, this.unsigned) : g(this.high >> a - 32, this.high >= 0 ? 0 : -1, this.unsigned)
    }, y.shr = y.shiftRight, y.shiftRightUnsigned = function (a) {
        var c, d;
        return b(a) && (a = a.toInt()), a &= 63, 0 === a ? this : (c = this.high, 32 > a ? (d = this.low, g(d >>> a | c << 32 - a, c >>> a, this.unsigned)) : 32 === a ? g(c, 0, this.unsigned) : g(c >>> a - 32, 0, this.unsigned))
        ...
        function m(a, b) {
            ...
            do {
                ...
                h = a[b++], i += (127 & h) * j, j *= 128
            } while (0 != (128 & h));
            if (k = b + i, k > a.length) return [null, c];
            switch (m = new l(f), f) {
                case d.CONNACK:
                    n = a[b++], 1 & n && (m.sessionPresent = !0), m.returnCode = a[b++];
                    break;
                case d.PUBLISH:
                    o = 3 & g >> 1, q = p(a, b), b += 2, r = t(a, b, q), b += q, o > 0 && (m.messageIdentifier = p(a, b), b += 2), s = new Paho.MQTT.Message(a.subarray(b, k)), 1 == (1 & g) && (s.retained = !0), 8 == (8 & g) && (s.duplicate = !0), s.qos = o, s.destinationName = r, m.payloadMessage = s;
                    break;
                case d.PUBACK:
                case d.PUBREC:
                case d.PUBREL:
                ...
                case d.UNSUBACK:
                    ...
                    break;
                case d.SUBACK:
                    m.messageIdentifier = p(a, b), b += 2, m.returnCode = a.subarray(b, k)
            }
            return [m, k]
        }
        ...
        function q(a) {
            var d, b = new Array(1),
                c = 0;
            do d = a % 128, a >>= 7, a > 0 && (d |= 128), b[c++] = d; while (a > 0 && 4 > c);
            return b
        }

        function r(a) {
            var c, d, b = 0;
            for (c = 0; c < a.length; c++) d = a.charCodeAt(c), d > 2047 ? (d >= 55296 && 56319 >= d && (c++, b++), b += 3) : d > 127 ? b += 2 : b++;
            return b
        }
        ...
        function s(a, b, c) {
            ...
            for (e = 0; e < a.length; e++) {
                if (f = a.charCodeAt(e), f >= 55296 && 56319 >= f) {
                    if (h = a.charCodeAt(++e), isNaN(h)) throw new Error(i(g.MALFORMED_UNICODE, [f, h]));
                    f = (f - 55296 << 10) + (h - 56320) + 65536
                }
                127 >= f ? b[d++] = f : 2047 >= f ? (b[d++] = 192 | 31 & f >> 6, b[d++] = 128 | 63 & f) : 65535 >= f ? (b[d++] = 224 | 15 & f >> 12, b[d++] = 128 | 63 & f >> 6, b[d++] = 128 | 63 & f) : (b[d++] = 240 | 7 & f >> 18, b[d++] = 128 | 63 & f >> 12, b[d++] = 128 | 63 & f >> 6, b[d++] = 128 | 63 & f)
            }
            return b
        }
        ...
        function t(a, b, c) {
            for (var e, h, j, k, l, d = "", f = b; b + c > f;) {
                if (h = a[f++], 128 > h) e = h;
                    ...
                    if (j = a[f++] - 128, 0 > j) throw new Error(i(g.MALFORMED_UTF, [h.toString(16), j.toString(16), ""]));
                    if (224 > h) e = 64 * (h - 192) + j;
                    else {
                        if (k = a[f++] - 128, 0 > k) throw new Error(i(g.MALFORMED_UTF, [h.toString(16), j.toString(16), k.toString(16)]));
                        if (240 > h) e = 4096 * (h - 224) + 64 * j + k;
                        else {
                            if (l = a[f++] - 128, 0 > l) throw new Error(i(g.MALFORMED_UTF, [h.toString(16), j.toString(16), k.toString(16), l.toString(16)]));
                            if (!(248 > h)) throw new Error(i(g.MALFORMED_UTF, [h.toString(16), j.toString(16), k.toString(16), l.toString(16)]));
                            e = 262144 * (h - 240) + 4096 * j + 64 * k + l
                        }
                    }
                }
                e > 65535 && (e -= 65536, d += String.fromCharCode(55296 + (e >> 10)), e = 56320 + (1023 & e)), d += String.fromCharCode(e)
            }
            return d
        }
        var u, v, w, x, y, b = "@VERSION@",
            d = {
                CONNECT: 1,
                CONNACK: 2,
                PUBLISH: 3,
                ...
                for (c in a)
                    if (a.hasOwnProperty(c)) {
                        if (!b.hasOwnProperty(c)) {
                            ...
                            for (c in b) b.hasOwnProperty(c) && (d = d + " " + c);
                            throw new Error(d)
                        }
                        if (typeof a[c] !== b[c]) throw new Error(i(g.INVALID_TYPE, [typeof a[c], c]))
                    }
            },
            f = function (a, b) {
                return function () {
            ...
            i = function (a, b) {
                ...
                if (b)
                    for (f = 0; f < b.length; f++) d = "{" + f + "}", e = c.indexOf(d), e > 0 && (g = c.substring(0, e), h = c.substring(e + d.length), c = g + b[f] + h);
                return c
            },
            j = [0, 6, 77, 81, 73, 115, 100, 112, 3],
            k = [0, 4, 77, 81, 84, 84, 4],
            l = function (a, b) {
                this.type = a;
        ...
        return l.prototype.encode = function () {
            var f, g, h, i, l, m, p, s, a = (15 & this.type) << 4,
                b = 0,
                c = new Array,
                e = 0;
            switch (void 0 != this.messageIdentifier && (b += 2), this.type) {
                case d.CONNECT:
                    ...
                    b += r(this.clientId) + 2, void 0 != this.willMessage && (b += r(this.willMessage.destinationName) + 2, f = this.willMessage.payloadBytes, f instanceof Uint8Array || (f = new Uint8Array(h)), b += f.byteLength + 2), void 0 != this.userName && (b += r(this.userName) + 2), void 0 != this.password && (b += r(this.password) + 2);
                    break;
                case d.SUBSCRIBE:
                    for (a |= 2, g = 0; g < this.topics.length; g++) c[g] = r(this.topics[g]), b += c[g] + 2;
                ...
                case d.PUBREL:
                    ...
                    break;
                case d.PUBLISH:
                    this.payloadMessage.duplicate && (a |= 8), a = a |= this.payloadMessage.qos << 1, this.payloadMessage.retained && (a |= 1), e = r(this.payloadMessage.destinationName), b += e + 2, h = this.payloadMessage.payloadBytes, b += h.byteLength, h instanceof ArrayBuffer ? h = new Uint8Array(h) : h instanceof Uint8Array || (h = new Uint8Array(h.buffer));
                    break;
                case d.DISCONNECT:
            }
            if (i = q(b), l = i.length + 1, m = new ArrayBuffer(b + l), p = new Uint8Array(m), p[0] = a, p.set(i, 1), this.type == d.PUBLISH) l = o(this.payloadMessage.destinationName, e, p, l);
            else if (this.type == d.CONNECT) {
                switch (this.mqttVersion) {
                    case 3:
                        p.set(j, l), l += j.length;
                        break;
                    case 4:
                        p.set(k, l), l += k.length
                }
                s = 0, this.cleanSession && (s = 2), void 0 != this.willMessage && (s |= 4, s |= this.willMessage.qos << 3, this.willMessage.retained && (s |= 32)), void 0 != this.userName && (s |= 128), void 0 != this.password && (s |= 64), p[l++] = s, l = n(this.keepAliveInterval, p, l)
            }
            switch (void 0 != this.messageIdentifier && (l = n(this.messageIdentifier, p, l)), this.type) {
                case d.CONNECT:
                    l = o(this.clientId, r(this.clientId), p, l), void 0 != this.willMessage && (l = o(this.willMessage.destinationName, r(this.willMessage.destinationName), p, l), l = n(f.byteLength, p, l), p.set(f, l), l += f.byteLength), void 0 != this.userName && (l = o(this.userName, r(this.userName), p, l)), void 0 != this.password && (l = o(this.password, r(this.password), p, l));
                    break;
                case d.PUBLISH:
                    p.set(h, l);
                    break;
                case d.SUBSCRIBE:
                    for (g = 0; g < this.topics.length; g++) l = o(this.topics[g], c[g], p, l), p[l++] = this.requestedQos[g];
                    break;
                case d.UNSUBSCRIBE:
                    for (g = 0; g < this.topics.length; g++) l = o(this.topics[g], c[g], p, l)
            }
            return m
        }, u = function (a, b, c) {
            var e, f, h;
            this._client = a, this._window = b, this._keepAliveInterval = 1e3 * c, this.isReset = !1, e = new l(d.PINGREQ).encode(), f = function (a) {
                return function () {
                    return h.apply(a)
                }
            }, h = function () {
                this.isReset ? (this.isReset = !1, this._client._trace("Pinger.doPing", "send PINGREQ"), this._client.socket.send(e), this.timeout = this._window.setTimeout(f(this), this._keepAliveInterval)) : (this._client._trace("Pinger.doPing", "Timed out"), this._client._disconnected(g.PING_TIMEOUT.code, i(g.PING_TIMEOUT)))
            }, this.reset = function () {
                this.isReset = !0, this._window.clearTimeout(this.timeout), this._keepAliveInterval > 0 && (this.timeout = setTimeout(f(this), this._keepAliveInterval))
            ...
            if (!("WebSocket" in a && null !== a["WebSocket"])) throw new Error(i(g.UNSUPPORTED, ["WebSocket"]));
            if (!("localStorage" in a && null !== a["localStorage"])) throw new Error(i(g.UNSUPPORTED, ["localStorage"]));
            if (!("ArrayBuffer" in a && null !== a["ArrayBuffer"])) throw new Error(i(g.UNSUPPORTED, ["ArrayBuffer"]));
            this._trace("Paho.MQTT.Client", b, c, d, e, f), this.host = c, this.port = d, this.path = e, this.uri = b, this.clientId = f, this._localKey = c + ":" + d + ("/mqtt" != e ? ":" + e : "") + ":" + f + ":", this._msg_queue = [], this._sentMessages = {}, this._receivedMessages = {}, this._notify_msg_sent = {}, this._message_identifier = 1, this._sequence = 0;
            for (var h in localStorage)(0 == h.indexOf("Sent:" + this._localKey) || 0 == h.indexOf("Received:" + this._localKey)) && this.restore(h)
        }, w.prototype.host, w.prototype.port, w.prototype.path, w.prototype.uri, w.prototype.clientId, w.prototype.socket, w.prototype.connected = !1, w.prototype.maxMessageIdentifier = 65536, w.prototype.connectOptions, w.prototype.hostIndex, w.prototype.onConnectionLost, w.prototype.onMessageDelivered, w.prototype.onMessageArrived, w.prototype.traceFunction, w.prototype._msg_queue = null, w.prototype._connectTimeout, w.prototype.sendPinger = null, w.prototype.receivePinger = null, w.prototype.receiveBuffer = null, w.prototype._traceBuffer = null, w.prototype._MAX_TRACE_ENTRIES = 100, w.prototype.connect = function (a) {
            var b = this._traceMask(a, "password");
            this._trace("Client.connect", b, this.socket, this.connected), this.connectOptions = a, a.uris ? (this.hostIndex = 0, this._doConnect(a.uris[0])) : this._doConnect(this.uri)
        }, w.prototype.subscribe = function (a, b) {
            if (this._trace("Client.subscribe", a, b), !this.connected) throw new Error(i(g.INVALID_STATE, ["not connected"]));
            var c = new l(d.SUBSCRIBE);
            c.topics = [a], c.requestedQos = void 0 != b.qos ? [b.qos] : [0], b.onSuccess && (c.onSuccess = function (a) {
                b.onSuccess({
            ...
            if (this._trace("Client.unsubscribe", a, b), !this.connected) throw new Error(i(g.INVALID_STATE, ["not connected"]));
            ...
            if (this._trace("Client.send", a), !this.connected) throw new Error(i(g.INVALID_STATE, ["not connected"]));
            wireMessage = new l(d.PUBLISH), wireMessage.payloadMessage = a, a.qos > 0 ? this._requires_ack(wireMessage) : this.onMessageDelivered && (this._notify_msg_sent[wireMessage] = this.onMessageDelivered(wireMessage.payloadMessage)), this._schedule_message(wireMessage)
        }, w.prototype.disconnect = function () {
            if (this._trace("Client.disconnect"), !this.socket) throw new Error(i(g.INVALID_STATE, ["not connecting or connected"]));
            wireMessage = new l(d.DISCONNECT), this._notify_msg_sent[wireMessage] = f(this._disconnected, this), this._schedule_message(wireMessage)
            ...
            null === this._traceBuffer && (this._traceBuffer = []), this._trace("Client.startTrace", new Date, b)
            ...
            this.connected = !1, this.socket = this.connectOptions.mqttVersion < 4 ? new WebSocket(a) : new WebSocket(a), this.socket.binaryType = "arraybuffer", this.socket.onopen = f(this._on_socket_open, this), this.socket.onmessage = f(this._on_socket_message, this), this.socket.onerror = f(this._on_socket_error, this), this.socket.onclose = f(this._on_socket_close, this), this.sendPinger = new u(this, window, this.connectOptions.keepAliveInterval), this.receivePinger = new u(this, window, this.connectOptions.keepAliveInterval), this._connectTimeout = new v(this, window, this.connectOptions.timeout, this._disconnected, [g.CONNECT_TIMEOUT.code, i(g.CONNECT_TIMEOUT)])
            ...
            switch (b.type) {
                case d.PUBLISH:
                    for (b.pubRecReceived && (c.pubRecReceived = !0), c.payloadMessage = {}, e = "", f = b.payloadMessage.payloadBytes, h = 0; h < f.length; h++) f[h] <= 15 ? e = e + "0" + f[h].toString(16) : e += f[h].toString(16);
                    c.payloadMessage.payloadHex = e, c.payloadMessage.qos = b.payloadMessage.qos, c.payloadMessage.destinationName = b.payloadMessage.destinationName, b.payloadMessage.duplicate && (c.payloadMessage.duplicate = !0), b.payloadMessage.retained && (c.payloadMessage.retained = !0), 0 == a.indexOf("Sent:") && (void 0 === b.sequence && (b.sequence = ++this._sequence), c.sequence = b.sequence);
                    break;
                default:
            ...
            var f, h, j, k, m, n, b = localStorage.getItem(a),
                c = JSON.parse(b),
                e = new l(c.type, c);
            switch (c.type) {
                case d.PUBLISH:
                    for (f = c.payloadMessage.payloadHex, h = new ArrayBuffer(f.length / 2), j = new Uint8Array(h), k = 0; f.length >= 2;) m = parseInt(f.substring(0, 2), 16), f = f.substring(2, f.length), j[k++] = m;
                    n = new Paho.MQTT.Message(j), n.qos = c.payloadMessage.qos, n.destinationName = c.payloadMessage.destinationName, c.payloadMessage.duplicate && (n.duplicate = !0), c.payloadMessage.retained && (n.retained = !0), e.payloadMessage = n;
                    break;
                default:
                    throw Error(i(g.INVALID_STORED_DATA, [a, b]))
            }
            0 == a.indexOf("Sent:" + this._localKey) ? (e.payloadMessage.duplicate = !0, this._sentMessages[e.messageIdentifier] = e) : 0 == a.indexOf("Received:" + this._localKey) && (this._receivedMessages[e.messageIdentifier] = e)
            ...
            a.messageIdentifier = this._message_identifier, this._sentMessages[a.messageIdentifier] = a, a.type === d.PUBLISH && this.store("Sent:", a), this._message_identifier === this.maxMessageIdentifier && (this._message_identifier = 1)
            ...
            var b, c;
            for (this._trace("Client._on_socket_message", a.data), this.receivePinger.reset(), b = this._deframeMessages(a.data), c = 0; c < b.length; c += 1) this._handleMessage(b[c])
        }, w.prototype._deframeMessages = function (a) {
            var c, d, e, f, h, b = new Uint8Array(a);
            this.receiveBuffer && (c = new Uint8Array(this.receiveBuffer.length + b.length), c.set(this.receiveBuffer), c.set(b, this.receiveBuffer.length), b = c, delete this.receiveBuffer);
            try {
                for (d = 0, e = []; d < b.length && (f = m(b, d), h = f[0], d = f[1], null !== h);) e.push(h);
                d < b.length && (this.receiveBuffer = b.subarray(d))
            } catch (j) {
                return this._disconnected(g.INTERNAL_ERROR.code, i(g.INTERNAL_ERROR, [j.message, j.stack.toString()])), void 0
            }
            return e
            ...
            try {
                switch (a.type) {
                    case d.CONNACK:
                        if (this._connectTimeout.cancel(), this.connectOptions.cleanSession) {
                            ...
                            this._sentMessages = {};
                            for (b in this._receivedMessages) e = this._receivedMessages[b], localStorage.removeItem("Received:" + this._localKey + e.messageIdentifier);
                        ...
                        this.connected = !0, this.connectOptions.uris && (this.hostIndex = this.connectOptions.uris.length), f = new Array;
                        for (j in this._sentMessages) this._sentMessages.hasOwnProperty(j) && f.push(this._sentMessages[j]);
                        for (f = f.sort(function (a, b) {
                                return a.sequence - b.sequence
                            }), k = 0, m = f.length; m > k; k++) c = f[k], c.type == d.PUBLISH && c.pubRecReceived ? (n = new l(d.PUBREL, {
                    ...
                    case d.PUBACK:
                        ...
                        break;
                    case d.PUBREC:
                        c = this._sentMessages[a.messageIdentifier], c && (c.pubRecReceived = !0, n = new l(d.PUBREL, {
                            messageIdentifier: a.messageIdentifier
                        }), this.store("Sent:", c), this._schedule_message(n));
                        break;
                    case d.PUBREL:
                        e = this._receivedMessages[a.messageIdentifier], localStorage.removeItem("Received:" + this._localKey + a.messageIdentifier), e && (this._receiveMessage(e), delete this._receivedMessages[a.messageIdentifier]), o = new l(d.PUBCOMP, {
                            messageIdentifier: a.messageIdentifier
                    ...
                    case d.PUBCOMP:
                        ...
                        break;
                    case d.SUBACK:
                        c = this._sentMessages[a.messageIdentifier], c && (c.timeOut && c.timeOut.cancel(), 128 === a.returnCode[0] ? c.onFailure && c.onFailure(a.returnCode) : c.onSuccess && c.onSuccess(a.returnCode), delete this._sentMessages[a.messageIdentifier]);
                        break;
                    case d.UNSUBACK:
                ...
                return this._disconnected(g.INTERNAL_ERROR.code, i(g.INTERNAL_ERROR, [p.message, p.stack.toString()])), void 0
            }
            ...
            this.socket.send(a.encode()), this.sendPinger.reset()
            ...
            switch (a.payloadMessage.qos) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    this._receivedMessages[a.messageIdentifier] = a, this.store("Received:", a), c = new l(d.PUBREC, {
                        messageIdentifier: a.messageIdentifier
            ...
            if (this.traceFunction) {
                for (a in arguments) "undefined" != typeof arguments[a] && (arguments[a] = JSON.stringify(arguments[a]));
                b = Array.prototype.slice.call(arguments).join(""), this.traceFunction({
                    severity: "Debug",
                    message: b
                })
            }
            if (null !== this._traceBuffer)
                for (a = 0, c = arguments.length; c > a; a++) this._traceBuffer.length == this._MAX_TRACE_ENTRIES && this._traceBuffer.shift(), 0 === a ? this._traceBuffer.push(arguments[a]) : "undefined" == typeof arguments[a] ? this._traceBuffer.push(arguments[a]) : this._traceBuffer.push("  " + JSON.stringify(arguments[a]))
            ...
            var f, h, j, k, l, m, n;
            if ("string" != typeof a) throw new Error(i(g.INVALID_TYPE, [typeof a, "host"]));
            if (2 == arguments.length) {
                if (d = b, f = a, h = f.match(/^(wss?):\/\/((\[(.+)\])|([^\/]+?))(:(\d+))?(\/.*)$/), !h) throw new Error(i(g.INVALID_ARGUMENT, [a, "host"]));
                a = h[4] || h[2], b = parseInt(h[7]), c = h[8]
            } else {
                if (3 == arguments.length && (d = c, c = "/mqtt"), "number" != typeof b || 0 > b) throw new Error(i(g.INVALID_TYPE, [typeof b, "port"]));
                if ("string" != typeof c) throw new Error(i(g.INVALID_TYPE, [typeof c, "path"]));
                j = -1 != a.indexOf(":") && "[" != a.slice(0, 1) && "]" != a.slice(-1), f = "ws://" + (j ? "[" + a + "]" : a) + ":" + b + c
            }
            for (k = 0, l = 0; l < d.length; l++) m = d.charCodeAt(l), m >= 55296 && 56319 >= m && l++, k++;
            if ("string" != typeof d || k > 65535) throw new Error(i(g.INVALID_ARGUMENT, [d, "clientId"]));
            n = new w(f, a, b, c, d), this._getHost = function () {
                return a
                ...
                if ("function" != typeof a) throw new Error(i(g.INVALID_TYPE, [typeof a, "onConnectionLost"]));
                ...
                if ("function" != typeof a) throw new Error(i(g.INVALID_TYPE, [typeof a, "onMessageDelivered"]));
                n.onMessageDelivered = a
            }, this._getOnMessageArrived = function () {
                return n.onMessageArrived
            }, this._setOnMessageArrived = function (a) {
                if ("function" != typeof a) throw new Error(i(g.INVALID_TYPE, [typeof a, "onMessageArrived"]));
                n.onMessageArrived = a
            }, this._getTrace = function () {
                return n.traceFunction
            }, this._setTrace = function (a) {
                if ("function" != typeof a) throw new Error(i(g.INVALID_TYPE, [typeof a, "onTrace"]));
                n.traceFunction = a
                ...
                if (a = a || {}, e(a, {
                        ...
                        ports: "object",
                        mqttVersion: "number"
                    }), void 0 === a.keepAliveInterval && (a.keepAliveInterval = 60), a.mqttVersion > 4 || a.mqttVersion < 3) throw new Error(i(g.INVALID_ARGUMENT, [a.mqttVersion, "connectOptions.mqttVersion"]));
                if (void 0 === a.mqttVersion ? (a.mqttVersionExplicit = !1, a.mqttVersion = 4) : a.mqttVersionExplicit = !0, void 0 === a.password && void 0 !== a.userName) throw new Error(i(g.INVALID_ARGUMENT, [a.password, "connectOptions.password"]));
                if (a.willMessage) {
                    if (!(a.willMessage instanceof y)) throw new Error(i(g.INVALID_TYPE, [a.willMessage, "connectOptions.willMessage"]));
                    if (a.willMessage.stringPayload, "undefined" == typeof a.willMessage.destinationName) throw new Error(i(g.INVALID_TYPE, [typeof a.willMessage.destinationName, "connectOptions.willMessage.destinationName"]))
                }
                if ("undefined" == typeof a.cleanSession && (a.cleanSession = !0), a.hosts) {
                    if (!(a.hosts instanceof Array)) throw new Error(i(g.INVALID_ARGUMENT, [a.hosts, "connectOptions.hosts"]));
                    if (a.hosts.length < 1) throw new Error(i(g.INVALID_ARGUMENT, [a.hosts, "connectOptions.hosts"]));
                    for (b = !1, d = 0; d < a.hosts.length; d++) {
                        if ("string" != typeof a.hosts[d]) throw new Error(i(g.INVALID_TYPE, [typeof a.hosts[d], "connectOptions.hosts[" + d + "]"]));
                        if (/^(wss?):\/\/((\[(.+)\])|([^\/]+?))(:(\d+))?(\/.*)$/.test(a.hosts[d])) {
                            if (0 == d) b = !0;
                            else if (!b) throw new Error(i(g.INVALID_ARGUMENT, [a.hosts[d], "connectOptions.hosts[" + d + "]"]))
                        } else if (b) throw new Error(i(g.INVALID_ARGUMENT, [a.hosts[d], "connectOptions.hosts[" + d + "]"]))
                    }
                    if (b) a.uris = a.hosts;
                    else {
                        if (!a.ports) throw new Error(i(g.INVALID_ARGUMENT, [a.ports, "connectOptions.ports"]));
                        if (!(a.ports instanceof Array)) throw new Error(i(g.INVALID_ARGUMENT, [a.ports, "connectOptions.ports"]));
                        if (a.hosts.length != a.ports.length) throw new Error(i(g.INVALID_ARGUMENT, [a.ports, "connectOptions.ports"]));
                        for (a.uris = [], d = 0; d < a.hosts.length; d++) {
                            if ("number" != typeof a.ports[d] || a.ports[d] < 0) throw new Error(i(g.INVALID_TYPE, [typeof a.ports[d], "connectOptions.ports[" + d + "]"]));
                            h = a.hosts[d], j = a.ports[d], k = -1 != h.indexOf(":"), f = "ws://" + (k ? "[" + h + "]" : h) + ":" + j + c, a.uris.push(f)
                        }
                    }
                }
                n.connect(a)
                ...
                if ("undefined" != typeof b.qos && 0 !== b.qos && 1 !== b.qos && 2 !== b.qos) throw new Error(i(g.INVALID_ARGUMENT, [b.qos, "subscribeOptions.qos"]));
                n.subscribe(a, b)
                ...
                if (1 == arguments.length) {
                    if (!(a instanceof y) && "string" != typeof a) throw new Error("Invalid argument:" + typeof a);
                    if (e = a, "undefined" == typeof e.destinationName) throw new Error(i(g.INVALID_ARGUMENT, [e.destinationName, "Message.destinationName"]));
                    n.send(e)
                } else e = new y(b), e.destinationName = a, arguments.length >= 3 && (e.qos = c), arguments.length >= 4 && (e.retained = d), n.send(e)
            ...
            var b, c, d, e, f;
            if (!("string" == typeof a || a instanceof ArrayBuffer || a instanceof Int8Array || a instanceof Uint8Array || a instanceof Int16Array || a instanceof Uint16Array || a instanceof Int32Array || a instanceof Uint32Array || a instanceof Float32Array || a instanceof Float64Array)) throw i(g.INVALID_ARGUMENT, [a, "newPayload"]);
            b = a, this._getPayloadString = function () {
                return "string" == typeof b ? b : t(b, 0, b.length)
            }, this._getPayloadBytes = function () {
                var a, c;
                return "string" == typeof b ? (a = new ArrayBuffer(r(b)), c = new Uint8Array(a), s(b, c, 0), c) : b
            }, c = void 0, this._getDestinationName = function () {
                return c
            }, this._setDestinationName = function (a) {
                if ("string" != typeof a) throw new Error(i(g.INVALID_ARGUMENT, [a, "newDestinationName"]));
                c = a
            }, d = 0, this._getQos = function () {
                return d
            }, this._setQos = function (a) {
                if (0 !== a && 1 !== a && 2 !== a) throw new Error("Invalid argument:" + a);
                d = a
            }, e = !1, this._getRetained = function () {
                return e
            }, this._setRetained = function (a) {
                if ("boolean" != typeof a) throw new Error(i(g.INVALID_ARGUMENT, [a, "newRetained"]));
                e = a
            }, f = !1, this._getDuplicate = function () {
                return f
    ...
    function (a, b) {
        ...
        function g() {
            var a = [],
                b = [];
            return function () {
                return 0 === arguments.length ? b.join("") + e.apply(String, a) : (a.length + arguments.length > 1024 && (b.push(e.apply(String, a)), a.length = 0), Array.prototype.push.apply(a, arguments), void 0)
            }
        }
        ...
        var c, d, e, j, k, b = function (a, c, e) {
            if ("undefined" == typeof a && (a = b.DEFAULT_CAPACITY), "undefined" == typeof c && (c = b.DEFAULT_ENDIAN), "undefined" == typeof e && (e = b.DEFAULT_NOASSERT), !e) {
                if (a = 0 | a, 0 > a) throw RangeError("Illegal capacity");
                c = !!c, e = !!e
            }
            this.buffer = 0 === a ? d : new ArrayBuffer(a), this.view = 0 === a ? null : new Uint8Array(this.buffer), this.offset = 0, this.markedOffset = -1, this.limit = a, this.littleEndian = c, this.noAssert = e
        };
        return b.VERSION = "5.0.1", b.LITTLE_ENDIAN = !0, b.BIG_ENDIAN = !1, b.DEFAULT_CAPACITY = 16, b.DEFAULT_ENDIAN = b.BIG_ENDIAN, b.DEFAULT_NOASSERT = !1, b.Long = a || null, c = b.prototype, c.__isByteBuffer__, Object.defineProperty(c, "__isByteBuffer__", {
            ...
            var f, i, g, h, k, j;
            for (("boolean" == typeof c || "string" != typeof c) && (e = d, d = c, c = void 0), f = 0, g = 0, h = a.length; h > g; ++g) b.isByteBuffer(a[g]) || (a[g] = b.wrap(a[g], c)), i = a[g].limit - a[g].offset, i > 0 && (f += i);
            if (0 === f) return new b(0, d, e);
            for (j = new b(f, d, e), g = 0; h > g;) k = a[g++], i = k.limit - k.offset, 0 >= i || (j.view.set(k.view.subarray(k.offset, k.limit), j.offset), j.offset += i);
            ...
            var g, h;
            if ("string" != typeof d && (f = e, e = d, d = void 0), "string" == typeof a) switch ("undefined" == typeof d && (d = "utf8"), d) {
                case "base64":
            ...
            if (a instanceof Uint8Array) g = new b(0, e, f), a.length > 0 && (g.buffer = a.buffer, g.offset = a.byteOffset, g.limit = a.byteOffset + a.byteLength, g.view = new Uint8Array(a.buffer));
            else if (a instanceof ArrayBuffer) g = new b(0, e, f), a.byteLength > 0 && (g.buffer = a, g.offset = 0, g.limit = a.byteLength, g.view = a.byteLength > 0 ? new Uint8Array(a) : null);
            else {
            ...
            if (d > f)
                for (i = 0, h = this.readByte(a++); d > f;) g[f++] = !!(1 & h >> i++);
            return b && (this.offset = a), g
        }, c.readBytes = function (a, b) {
            var d, c = "undefined" == typeof b;
            if (c && (b = this.offset), !this.noAssert) {
                if ("number" != typeof b || 0 !== b % 1) throw TypeError("Illegal offset: " + b + " (not an integer)");
                if (b >>>= 0, 0 > b || b + a > this.buffer.byteLength) throw RangeError("Illegal offset: 0 <= " + b + " (+" + a + ") <= " + this.buffer.byteLength)
            }
            ...
            return c = this.view[a], 128 === (128 & c) && (c = -(255 - c + 1)), b && (this.offset += 1), c
            ...
            return c = 0, this.littleEndian ? (c = this.view[a], c |= this.view[a + 1] << 8) : (c = this.view[a] << 8, c |= this.view[a + 1]), 32768 === (32768 & c) && (c = -(65535 - c + 1)), b && (this.offset += 2), c
            ...
            return a >>>= 0, 128 > a ? 1 : 16384 > a ? 2 : 1 << 21 > a ? 3 : 1 << 28 > a ? 4 : 5
            ...
            do {
                ...
                e = this.view[a++], 5 > c && (d |= (127 & e) << 7 * c), ++c
            } while (0 !== (128 & e));
            ...
            return "object" == typeof c ? c["value"] = b.zigZagDecode32(c["value"]) : c = b.zigZagDecode32(c), c
            ...
            if (e && (d = this.offset), !this.noAssert) {
                if ("number" == typeof c) c = a.fromNumber(c);
                else if ("string" == typeof c) c = a.fromString(c);
                else if (!(c && c instanceof a)) throw TypeError("Illegal value: " + c + " (not an integer or Long)");
            ...
            switch ("number" == typeof c ? c = a.fromNumber(c, !1) : "string" == typeof c ? c = a.fromString(c, !1) : c.unsigned !== !1 && (c = c.toSigned()), f = b.calculateVarint64(c), g = c.toInt() >>> 0, h = c.shiftRightUnsigned(28).toInt() >>> 0, i = c.shiftRightUnsigned(56).toInt() >>> 0, d += f, j = this.buffer.byteLength, d > j && this.resize((j *= 2) > d ? j : d), d -= f, f) {
                case 10:
                    this.view[d + 9] = 1 & i >>> 7;
                case 9:
            ...
            var e, i, f, h, j;
            if ("number" == typeof c && (d = c, c = void 0), e = "undefined" == typeof d, e && (d = this.offset), "undefined" == typeof c && (c = b.METRICS_CHARS), !this.noAssert) {
                if ("number" != typeof a || 0 !== a % 1) throw TypeError("Illegal length: " + a + " (not an integer)");
                if (a |= 0, "number" != typeof d || 0 !== d % 1) throw TypeError("Illegal offset: " + d + " (not an integer)");
                if (d >>>= 0, 0 > d || d + 0 > this.buffer.byteLength) throw RangeError("Illegal offset: 0 <= " + d + " (+" + 0 + ") <= " + this.buffer.byteLength)
            }
            ...
            if (c === b.METRICS_BYTES) {
                if (!this.noAssert) {
                    if ("number" != typeof d || 0 !== d % 1) throw TypeError("Illegal offset: " + d + " (not an integer)");
                    if (d >>>= 0, 0 > d || d + a > this.buffer.byteLength) throw RangeError("Illegal offset: 0 <= " + d + " (+" + a + ") <= " + this.buffer.byteLength)
                }
            ...
            var e, f, g;
            if (("number" == typeof c || "string" != typeof c) && (d = c, c = void 0), e = "undefined" == typeof d, e && (d = this.offset), !this.noAssert) {
                if ("number" != typeof d || 0 !== d % 1) throw TypeError("Illegal offset: " + d + " (not an integer)");
                if (d >>>= 0, 0 > d || d + 0 > this.buffer.byteLength) throw RangeError("Illegal offset: 0 <= " + d + " (+" + 0 + ") <= " + this.buffer.byteLength)
            }
            return a instanceof b || (a = b.wrap(a, c)), f = a.limit - a.offset, 0 >= f ? this : (d += f, g = this.buffer.byteLength, d > g && this.resize((g *= 2) > d ? g : d), d -= f, this.view.set(a.view.subarray(a.offset, a.limit), d), a.offset += f, e && (this.offset += f), this)
            ...
            if ("undefined" == typeof a && (a = this.offset), "undefined" == typeof c && (c = this.limit), !this.noAssert) {
                if ("number" != typeof a || 0 !== a % 1) throw TypeError("Illegal begin: Not an integer");
            ...
            if (c = (g = "undefined" == typeof c) ? a.offset : 0 | c, d = (f = "undefined" == typeof d) ? this.offset : 0 | d, e = "undefined" == typeof e ? this.limit : 0 | e, 0 > c || c > a.buffer.byteLength) throw RangeError("Illegal target range: 0 <= " + c + " <= " + a.buffer.byteLength);
            if (0 > d || e > this.buffer.byteLength) throw RangeError("Illegal source range: 0 <= " + d + " <= " + this.buffer.byteLength);
            return h = e - d, 0 === h ? a : (a.ensureCapacity(c + h), a.view.set(this.view.subarray(d, e), c), f && (this.offset += h), g && (a.offset += h), this)
            ...
            return a || 0 !== b || c !== this.buffer.byteLength ? b === c ? d : (e = new ArrayBuffer(c - b), new Uint8Array(e).set(new Uint8Array(this.buffer).subarray(b, c), 0), e) : this.buffer
            ...
            return a.encode = function (a, c) {
                for (var d, e; null !== (d = a());) c(b[63 & d >> 2]), e = (3 & d) << 4, null !== (d = a()) ? (e |= 15 & d >> 4, c(b[63 & (e | 15 & d >> 4)]), e = (15 & d) << 2, null !== (d = a()) ? (c(b[63 & (e | 3 & d >> 6)]), c(b[63 & d])) : (c(b[63 & e]), c(61))) : (c(b[63 & e]), c(61), c(61))
            }, a.decode = function (a, b) {
                function g(a) {
                    throw Error("Illegal character code: " + a)
                }
                for (var d, e, f; null !== (d = a());)
                    if (e = c[d], "undefined" == typeof e && g(d), null !== (d = a()) && (f = c[d], "undefined" == typeof f && g(d), b(e << 2 >>> 0 | (48 & f) >> 4), null !== (d = a()))) {
                        if (e = c[d], "undefined" == typeof e) {
                            if (61 === d) break;
                            g(d)
                        }
                        if (b((15 & f) << 4 >>> 0 | (60 & e) >> 2), null !== (d = a())) {
                            if (f = c[d], "undefined" == typeof f) {
                                if (61 === d) break;
                                g(d)
                            }
                            b((3 & e) << 6 >>> 0 | f)
            ...
            if ("undefined" == typeof a && (a = this.offset), "undefined" == typeof b && (b = this.limit), a = 0 | a, b = 0 | b, 0 > a || b > this.capacity || a > b) throw RangeError("begin, end");
            var c;
            ...
            if ("undefined" == typeof a && (a = this.offset), "undefined" == typeof b && (b = this.limit), a |= 0, b |= 0, 0 > a || b > this.capacity() || a > b) throw RangeError("begin, end");
            if (a === b) return "";
            ...
            for (var d, b = -1, c = this.buffer.byteLength, e = "", f = "", g = ""; c > b;) {
                if (-1 !== b && (d = this.view[b], e += 16 > d ? "0" + d.toString(16).toUpperCase() : d.toString(16).toUpperCase(), a && (f += d > 32 && 127 > d ? String.fromCharCode(d) : ".")), ++b, a && b > 0 && 0 === b % 16 && b !== c) {
                    for (; e.length < 51;) e += " ";
                    g += e + f + "\n", e = f = ""
                }
            ...
            for (var i, j, e = a.length, f = new b(0 | (e + 1) / 3, c, d), g = 0, h = 0, k = !1, l = !1, m = !1, n = !1, o = !1; e > g;) {
                switch (i = a.charAt(g++)) {
                    ...
                    default:
                        ...
                        if (j = parseInt(i + a.charAt(g++), 16), !d && (isNaN(j) || 0 > j || j > 255)) throw TypeError("Illegal str: Not a debug encoded string");
                        f.view[h++] = j, k = !0
                }
            ...
            for (var d, c = new Array(b - a); b > a;) d = this.view[a++], 16 > d ? c.push("0", d.toString(16)) : c.push(d.toString(16));
            return c.join("")
            ...
            for (e = a.length, f = new b(0 | e / 2, c), h = 0, i = 0; e > h; h += 2) {
                if (g = parseInt(a.substring(h, h + 2), 16), !d && (!isFinite(g) || 0 > g || g > 255)) throw TypeError("Illegal str: Contains non-hex characters");
                f.view[i++] = g
            }
            return f.limit = i, f
        }, k = function () {
            ...
            return a.MAX_CODEPOINT = 1114111, a.encodeUTF8 = function (a, b) {
                ...
                for ("number" == typeof a && (c = a, a = function () {
                        return null
                    }); null !== c || null !== (c = a());) 128 > c ? b(127 & c) : 2048 > c ? (b(192 | 31 & c >> 6), b(128 | 63 & c)) : 65536 > c ? (b(224 | 15 & c >> 12), b(128 | 63 & c >> 6), b(128 | 63 & c)) : (b(240 | 7 & c >> 18), b(128 | 63 & c >> 12), b(128 | 63 & c >> 6), b(128 | 63 & c)), c = null
                ...
                for (var c, d = null;;) {
                    ...
                    c >= 55296 && 57343 >= c && null !== (d = a()) && d >= 56320 && 57343 >= d ? (b(1024 * (c - 55296) + d - 56320 + 65536), d = null) : b(c)
                }
                null !== d && b(d)
                ...
                for ("number" == typeof a && (c = a, a = function () {
                        return null
                    }); null !== c || null !== (c = a());) 65535 >= c ? b(c) : (c -= 65536, b((c >> 10) + 55296), b(c % 1024 + 56320)), c = null
                ...
                for (var b, c = 0; null !== (b = a());) c += 128 > b ? 1 : 2048 > b ? 2 : 65536 > b ? 3 : 4;
                return c
    ...
    function (a, b) {
        ...
        return c.ByteBuffer = a, c.Long = a.Long || null, c.VERSION = "5.0.1", c.WIRE_TYPES = {}, c.WIRE_TYPES.VARINT = 0, c.WIRE_TYPES.BITS64 = 1, c.WIRE_TYPES.LDELIM = 2, c.WIRE_TYPES.STARTGROUP = 3, c.WIRE_TYPES.ENDGROUP = 4, c.WIRE_TYPES.BITS32 = 5, c.PACKABLE_WIRE_TYPES = [c.WIRE_TYPES.VARINT, c.WIRE_TYPES.BITS64, c.WIRE_TYPES.BITS32], c.TYPES = {
            ...
            var a = {};
            return a.IS_NODE = !("object" != typeof process || "[object process]" != process + "" || process["browser"]), a.XHR = function () {
                var c, a = [function () {
                ...
                if (c && "function" != typeof c && (c = null), a.IS_NODE)
                    if (d = require("fs"), c) d.readFile(b, function (a, b) {
                        a ? c(null) : c("" + b)
                    });
                    else try {
                        ...
                        if (f = a.XHR(), f.open("GET", b, c ? !0 : !1), f.setRequestHeader("Accept", "text/plain"), "function" == typeof f.overrideMimeType && f.overrideMimeType("text/plain"), !c) return f.send(null), 200 == f.status || 0 == f.status && "string" == typeof f.responseText ? f.responseText : null;
            ...
            function h(a, c) {
                ...
                if ("-" == a.charAt(0) && (e = -1, a = a.substring(1)), b.NUMBER_DEC.test(a)) d = parseInt(a);
                    ...
                    if (!b.NUMBER_OCT.test(a)) throw Error("illegal id value: " + (0 > e ? "-" : "") + a);
                    d = parseInt(a.substring(1), 8)
                }
                if (d = 0 | e * d, !c && 0 > d) throw Error("illegal id value: " + (0 > e ? "-" : "") + a);
                return d
            }
            ...
            return e._readString = function () {
                ...
                if (this.index === this.source.length) return null;
                if (e = this.index, b.DELIM.lastIndex = 0, f = b.DELIM.test(this.source.charAt(e++)), !f)
                    for (; e < this.source.length && !b.DELIM.test(this.source.charAt(e));) ++e;
                ...
                try {
                    for (; c = this.tn.next();) switch (c) {
                        case "package":
                            if (!d || null !== a["package"]) throw Error("unexpected 'package'");
                        ...
                        case "import":
                            ...
                            c = this.tn.peek(), ("public" === c || (e = "weak" === c)) && this.tn.next(), c = this._readString(), this.tn.skip(";"), e || a["imports"].push(c);
                            break;
                        case "syntax":
                    ...
                    throw f.message = "Parse error at line " + this.tn.line + ": " + f.message, f
                }
                ...
                var d = this.tn.peek();
                if ("{" !== d) j(a["options"], c, this._readValue(!0));
                else
                    for (this.tn.skip("{");
                        "}" !== (d = this.tn.next());) {
                ...
                for (d = c, e = {
                    ...
                    "}" !== (c = this.tn.next());)
                    if ("option" === c) this._parseOption(e);
                    else {
                ...
                if (e = d, f = {
                        ...
                        response_stream: !1,
                        options: {}
                    }, this.tn.skip("("), d = this.tn.next(), "stream" === d.toLowerCase() && (f["request_stream"] = !0, d = this.tn.next()), !b.TYPEREF.test(d)) throw Error("illegal rpc service request type: " + d);
                ...
                for (f["name"] = e, d && (this.tn.skip("="), c["id"] = h(this.tn.next()), f["isGroup"] = !0), e = this.tn.peek(), "[" === e && c && this._parseFieldOptions(c), this.tn.skip("{");
                    "}" !== (e = this.tn.next());)
                    if (b.RULE.test(e)) this._parseMessageField(f, e);
                    else if ("oneof" === e) this._parseMessageOneOf(f);
                else if ("enum" === e) this._parseEnum(f);
                else if ("message" === e) this._parseMessage(f);
                else if ("option" === e) this._parseOption(f);
                else if ("service" === e) this._parseService(f);
                else if ("extensions" === e) f["extensions"] = f.hasOwnProperty("extensions") ? f["extensions"].concat(this._parseExtensionRanges()) : this._parseExtensionRanges();
                else if ("reserved" === e) this._parseIgnored();
                else if ("extend" === e) this._parseExtend(f);
                else {
                ...
                } else if (d = "undefined" != typeof d ? d : this.tn.next(), "group" === d) {
                ...
                for (d = c, f = [], this.tn.skip("{");
                    "}" !== (c = this.tn.next());) e = this._parseMessageField(a, "optional", c), e["oneof"] = d, f.push(e["id"]);
                ...
                for (c["name"] = d, this.tn.skip("{");
                    "}" !== (d = this.tn.next());)
                    if ("option" === d) this._parseOption(c);
                    else {
                        if (!b.NAME.test(d)) throw Error("illegal name: " + d);
                        this.tn.skip("="), e = {
                            name: d,
                ...
                for (d = {
                    ...
                    "}" !== (c = this.tn.next());)
                    if (b.RULE.test(c)) this._parseMessageField(d, c);
                    else {
            ...
            var f, g, h, i, l, m, o, p, q, r, s, t, u, v, w, x, y, z, A, c = {},
                d = function (a, b, c) {
            ...
            return e.fqn = function () {
                ...
                if (b = this.getChild(a.name))
                    if (b instanceof l.Field && b.name !== b.originalName && null === this.getChild(b.originalName)) b.name = b.originalName;
                    else {
                        if (!(a instanceof l.Field && a.name !== a.originalName && null === this.getChild(a.originalName))) throw Error("Duplicate name in namespace " + this.toString(!0) + ": " + a.name);
                ...
                var g, d = "string" == typeof a ? a.split(".") : a,
                    e = this,
                    f = 0;
                if ("" === d[f]) {
                ...
                var e, f, b = [],
                    d = a;
                do b.unshift(d.name), d = d.parent; while (null !== d);
                ...
                var e, c, d, a = {},
                    b = this.children;
                for (c = 0, d = b.length; d > c; ++c) e = b[c], e instanceof f && (a[e.name] = e.build());
            ...
            }, c.Namespace = f, h = function (a, c, d, e, f) {
            ...
            }, i = h.prototype, h.defaultFieldValue = j, i.toString = function () {
                ...
                switch (this.type) {
                    ...
                    case b.TYPES["sfixed32"]:
                        return ("number" != typeof c || c === c && 0 !== c % 1) && e(typeof c, "not an integer"), c > 4294967295 ? 0 | c : c;
                    case b.TYPES["uint32"]:
                    case b.TYPES["fixed32"]:
                        return ("number" != typeof c || c === c && 0 !== c % 1) && e(typeof c, "not an integer"), 0 > c ? c >>> 0 : c;
                    case b.TYPES["int64"]:
                    case b.TYPES["sint64"]:
                    ...
                    case b.TYPES["enum"]:
                        for (g = this.resolvedType.getChildren(b.Reflect.Enum.Value), i = 0; i < g.length; i++) {
                            if (g[i].name == c) return g[i].id;
                            if (g[i].id == c) return g[i].id
                        }
                        if ("proto3" === this.syntax) return ("number" != typeof c || c === c && 0 !== c % 1) && e(typeof c, "not an integer"), (c > 4294967295 || 0 > c) && e(typeof c, "not in range for uint32"), c;
                ...
                switch (this.type) {
                    ...
                    case b.TYPES["bytes"]:
                        if (d.remaining() < 0) throw Error("Illegal value for " + this.toString(!0) + ": " + d.remaining() + " bytes remaining");
                        f = d.offset, e.writeVarint32(d.remaining()), e.append(d), d.offset = f;
                        break;
                    case b.TYPES["message"]:
                        g = (new a).LE(), this.resolvedType.encode(d, g), e.writeVarint32(g.offset), e.append(g.flip());
                        break;
                    case b.TYPES["group"]:
            ...
            }, c.Element = h, l = function (a, b, c, d, e, g) {
                f.call(this, a, b, c, d, g), this.className = "Message", this.extensions = void 0, this.clazz = null, this.isGroup = !!e, this._fields = null, this._fieldsById = null, this._fieldsByName = null
            }, m = l.prototype = Object.create(f.prototype), m.build = function (c) {
                var d, g, e, f;
                if (this.clazz && !c) return this.clazz;
                for (d = function (b, c) {
                        function j(c, d, e, f) {
                            var g, h, i, k, l, m, n;
                            if (null === c || "object" != typeof c) return f && f instanceof b.Reflect.Enum && (g = b.Reflect.Enum.getName(f.object, c), null !== g) ? g : c;
                            if (a.isByteBuffer(c)) return d ? c.toBase64() : c.toBuffer();
                            if (b.Long.isLong(c)) return e ? c.toString() : b.Long.fromValue(c);
                            if (Array.isArray(c)) return h = [], c.forEach(function (a, b) {
                                h[b] = j(a, d, e, f)
                            }), h;
                            if (h = {}, c instanceof b.Map) {
                                for (i = c.entries(), k = i.next(); !k.done; k = i.next()) h[c.keyElem.valueToString(k.value[0])] = j(k.value[1], d, e, c.valueElem.resolvedType);
                                return h
                            }
                            l = c.$type, m = void 0;
                            for (n in c) c.hasOwnProperty(n) && (h[n] = l && (m = l.getChild(n)) ? j(c[n], d, e, m.resolvedType) : j(c[n], d, e));
                            return h
                        }
                        var h, i, d = c.getChildren(b.Reflect.Message.Field),
                            e = c.getChildren(b.Reflect.Message.OneOf),
                            f = function (g) {
                                var i, j, k, l;
                                for (b.Builder.Message.call(this), i = 0, j = e.length; j > i; ++i) this[e[i].name] = null;
                                for (i = 0, j = d.length; j > i; ++i) k = d[i], this[k.name] = k.repeated ? [] : k.map ? new b.Map(k) : null, !k.required && "proto3" !== c.syntax || null === k.defaultValue || (this[k.name] = k.defaultValue);
                                if (arguments.length > 0)
                                    if (1 !== arguments.length || null === g || "object" != typeof g || !("function" != typeof g.encode || g instanceof f) || Array.isArray(g) || g instanceof b.Map || a.isByteBuffer(g) || g instanceof ArrayBuffer || b.Long && g instanceof b.Long)
                                        for (i = 0, j = arguments.length; j > i; ++i) "undefined" != typeof (l = arguments[i]) && this.$set(d[i].name, l);
                                    else this.$set(g)
                            },
                        ...
                        for (g.add = function (a, d, e) {
                            ...
                            }, g.$add = g.add, g.set = function (a, d, e) {
                                var f, g, h;
                                if (a && "object" == typeof a) {
                                    e = d;
                                    for (f in a) a.hasOwnProperty(f) && "undefined" != typeof (d = a[f]) && this.$set(f, d, e);
                                    return this
                                }
                                if (g = c._fieldsByName[a], e) this[a] = d;
                                else {
                                ...
                                return g && g.oneof && (h = this[g.oneof.name], null !== d ? (null !== h && h !== g.name && (this[h] = null), this[g.oneof.name] = g.name) : h === a && (this[g.oneof.name] = null)), this
                            }, g.$set = g.set, g.get = function (a, d) {
                                if (d) return this[a];
                                ...
                                return this[e.name]
                            }, g.$get = g.get, h = 0; h < d.length; h++) i = d[h], i instanceof b.Reflect.Message.ExtensionField || c.builder.options["populateAccessors"] && function (a) {
                            ...
                            b = b.substring(0, 1).toUpperCase() + b.substring(1), d = a.originalName.replace(/([A-Z])/g, function (a) {
                                ...
                                return this[a.name]
                            }, null === c.getChild("set" + b) && (g["set" + b] = e), null === c.getChild("set_" + d) && (g["set_" + d] = e), null === c.getChild("get" + b) && (g["get" + b] = f), null === c.getChild("get_" + d) && (g["get_" + d] = f)
                        }(i);
                        return g.encode = function (b, d) {
                            var e, f;
                            "boolean" == typeof b && (d = b, b = void 0), e = !1, b || (b = new a, e = !0), f = b.littleEndian;
                            try {
                            ...
                            var f, e = !1;
                            return b || (b = new a, e = !0), f = (new a).LE(), c.encode(this, f, d).flip(), b.writeVarint32(f.remaining()), b.append(f), e ? b.flip() : b
                        }, g.encodeAB = function () {
                            try {
                        ...
                        }, g.toHex = g.encodeHex, g.toRaw = function (a, b) {
                            return j(this, !!a, !!b, this.$type)
                        }, g.encodeJSON = function () {
                            return JSON.stringify(j(this, !0, !0, this.$type))
                        }, f.decode = function (b, d, e) {
                            var f, g;
                            "string" == typeof d && (e = d, d = -1), "string" == typeof b ? b = a.wrap(b, e ? e : "base64") : a.isByteBuffer(b) || (b = a.wrap(b)), f = b.littleEndian;
                            try {
                                return g = c.decode(b.LE(), d), b.LE(f), g
                            } catch (h) {
                                throw b.LE(f), h
                            }
                        }, f.decodeDelimited = function (b, d) {
                            var e, f, g;
                            if ("string" == typeof b ? b = a.wrap(b, d ? d : "base64") : a.isByteBuffer(b) || (b = a.wrap(b)), b.remaining() < 1) return null;
                            if (e = b.offset, f = b.readVarint32(), b.remaining() < f) return b.offset = e, null;
                            try {
                    ...
                    }(b, this), this._fields = [], this._fieldsById = {}, this._fieldsByName = {}, e = 0, f = this.children.length; f > e; e++)
                    if (g = this.children[e], g instanceof s || g instanceof l || g instanceof w) {
                        if (d.hasOwnProperty(g.name)) throw Error("Illegal reflect child of " + this.toString(!0) + ": " + g.toString(!0) + " cannot override static property '" + g.name + "'");
                        d[g.name] = g.build()
                    } else if (g instanceof l.Field) g.build(), this._fields.push(g), this._fieldsById[g.id] = g, this._fieldsByName[g.name] = g;
                else if (!(g instanceof l.OneOf || g instanceof v)) throw Error("Illegal reflect child of " + this.toString(!0) + ": " + this.children[e].toString(!0));
                return this.clazz = d
            }, m.encode = function (a, b, c) {
                var e, h, f, g, i, d = null;
                for (f = 0, g = this._fields.length; g > f; ++f) e = this._fields[f], h = a[e.name], e.required && null === h ? null === d && (d = e) : e.encode(c ? h : e.verifyValue(h), b, a);
                if (null !== d) throw i = Error("Missing at least one required field for " + this.toString(!0) + ": " + d), i["encoded"] = b, i;
                return b
                ...
                for ("number" != typeof c && (c = -1), e = a.offset, f = new this.clazz; a.offset < e + c || -1 === c && a.remaining() > 0;) {
                    if (g = a.readVarint32(), h = 7 & g, i = g >>> 3, h === b.WIRE_TYPES.ENDGROUP) {
                        if (i !== d) throw Error("Illegal group end indicator for " + this.toString(!0) + ": " + i + " (" + (d ? d + " expected" : "not a group") + ")");
                        break
                    }
                    if (j = this._fieldsById[i]) j.repeated && !j.options["packed"] ? f[j.name].push(j.decode(h, a)) : j.map ? (l = j.decode(h, a), f[j.name].set(l[0], l[1])) : (f[j.name] = j.decode(h, a), j.oneof && (m = f[j.oneof.name], null !== m && m !== j.name && (f[m] = null), f[j.oneof.name] = j.name));
                    else switch (h) {
                        case b.WIRE_TYPES.VARINT:
                            a.readVarint32();
                            break;
                ...
                for (o = 0, p = this._fields.length; p > o; ++o)
                    if (j = this._fields[o], null === f[j.name])
                        if ("proto3" === this.syntax) f[j.name] = j.defaultValue;
                        else {
            ...
            }, c.Message = l, o = function (a, c, e, f, g, h, i, j, k, m) {
                d.call(this, a, c, h), this.className = "Message.Field", this.required = "required" === e, this.repeated = "repeated" === e, this.map = "map" === e, this.keyType = f || null, this.type = g, this.resolvedType = null, this.id = i, this.options = j || {}, this.defaultValue = null, this.oneof = k || null, this.syntax = m || "proto2", this.originalName = this.name, this.element = null, this.keyElement = null, !this.builder.options["convertFieldsToCamelCase"] || this instanceof l.ExtensionField || (this.name = b.Util.toCamelCase(this.name))
            }, p = o.prototype = Object.create(d.prototype), p.build = function () {
                this.element = new h(this.type, this.resolvedType, !1, this.syntax, this.name), this.map && (this.keyElement = new h(this.keyType, void 0, !0, this.syntax, this.name)), "proto3" !== this.syntax || this.repeated || this.map ? "undefined" != typeof this.options["default"] && (this.defaultValue = this.verifyValue(this.options["default"])) : this.defaultValue = h.defaultFieldValue(this.type)
            }, p.verifyValue = function (a, c) {
                function e(a, b) {
                    throw Error("Illegal value for " + d.toString(!0) + " of type " + d.type.name + ": " + a + " (" + b + ")")
                }
                var d, f, g;
                if (c = c || !1, d = this, null === a) return this.required && e(typeof a, "required"), "proto3" === this.syntax && this.type !== b.TYPES["message"] && e(typeof a, "proto3 field without field presence cannot be null"), null;
                if (this.repeated && !c) {
                    for (Array.isArray(a) || (a = [a]), g = [], f = 0; f < a.length; f++) g.push(this.element.verifyValue(a[f]));
                    return g
                }
                return this.map && !c ? a instanceof b.Map ? a : (a instanceof Object || e(typeof a, "expected ProtoBuf.Map or raw object for map field"), new b.Map(this, a)) : (!this.repeated && Array.isArray(a) && e(typeof a, "no array expected"), this.element.verifyValue(a))
                ...
                try {
                    if (this.repeated)
                        if (this.options["packed"] && b.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
                            for (d.writeVarint32(this.id << 3 | b.WIRE_TYPES.LDELIM), d.ensureCapacity(d.offset += 1), g = d.offset, f = 0; f < c.length; f++) this.element.encodeValue(this.id, c[f], d);
                            h = d.offset - g, i = a.calculateVarint32(h), i > 1 && (j = d.slice(g, d.offset), g += i - 1, d.offset = g, d.append(j)), d.writeVarint32(h, g - i)
                        } else
                            for (f = 0; f < c.length; f++) d.writeVarint32(this.id << 3 | this.type.wireType), this.element.encodeValue(this.id, c[f], d);
                    else this.map ? c.forEach(function (c, e) {
                ...
                try {
                    ...
                    else this.map ? c.forEach(function (c, d) {
                ...
                if (a == b.WIRE_TYPES.LDELIM && this.repeated && this.options["packed"] && b.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0 && !d) {
                    for (f = c.readVarint32(), f = c.offset + f, i = []; c.offset < f;) i.push(this.decode(this.type.wireType, c, !0));
                    return i
                }
                if (this.map) {
                    if (j = h.defaultFieldValue(this.keyType), e = h.defaultFieldValue(this.type), f = c.readVarint32(), c.remaining() < f) throw Error("Illegal number of bytes for " + this.toString(!0) + ": " + f + " required but got only " + c.remaining());
                    for (k = c.clone(), k.limit = k.offset + f, c.offset += f; k.remaining() > 0;)
                        if (l = k.readVarint32(), a = 7 & l, m = l >>> 3, 1 === m) j = this.keyElement.decode(k, a, m);
                        else {
            ...
            }, c.Message.Field = o, q = function (a, b, c, d, e, f, g) {
                o.call(this, a, b, c, null, d, e, f, g), this.extension
            }, q.prototype = Object.create(o.prototype), c.Message.ExtensionField = q, r = function (a, b, c) {
                d.call(this, a, b, c), this.fields = []
            }, c.Message.OneOf = r, s = function (a, b, c, d, e) {
                f.call(this, a, b, c, d, e), this.className = "Enum", this.object = null
            }, s.getName = function (a, b) {
                var e, d, c = Object.keys(a);
                for (d = 0; d < c.length; ++d)
                    if (a[e = c[d]] === b) return e;
                return null
            }, t = s.prototype = Object.create(f.prototype), t.build = function (a) {
                var c, d, e, f;
                if (this.object && !a) return this.object;
                for (c = new b.Builder.Enum, d = this.getChildren(s.Value), e = 0, f = d.length; f > e; ++e) c[d[e]["name"]] = d[e]["id"];
                return Object.defineProperty && Object.defineProperty(c, "$options", {
                    value: this.buildOpt(),
                    enumerable: !1
                }), this.object = c
            }, c.Enum = s, u = function (a, b, c, e) {
                d.call(this, a, b, c), this.className = "Enum.Value", this.id = e
            }, u.prototype = Object.create(d.prototype), c.Enum.Value = u, v = function (a, b, c, e) {
                d.call(this, a, b, c), this.field = e
            }, v.prototype = Object.create(d.prototype), c.Extension = v, w = function (a, b, c, d) {
                f.call(this, a, b, c, d), this.className = "Service", this.clazz = null
            }, x = w.prototype = Object.create(f.prototype), x.build = function (c) {
                return this.clazz && !c ? this.clazz : this.clazz = function (b, c) {
                    var g, d = function (a) {
                        ...
                        e = d.prototype = Object.create(b.Builder.Service.prototype),
                        f = c.getChildren(b.Reflect.Service.RPCMethod);
                    for (g = 0; g < f.length; g++) ! function (b) {
                        e[b.name] = function (d, e) {
                            try {
                                ...
                                d instanceof b.resolvedRequestType.clazz || (d = new b.resolvedRequestType.clazz(d)), this.rpcImpl(b.fqn(), d, function (a, d) {
                                    if (a) return e(a), void 0;
                                    null === d && (d = "");
                                    try {
                                        d = b.resolvedResponseType.clazz.decode(d)
                                    } catch (f) {}
                                    return d && d instanceof b.resolvedResponseType.clazz ? (e(null, d), void 0) : (e(Error("Illegal response type received in service method " + c.name + "#" + b.name)), void 0)
                                })
                            } catch (f) {
            ...
            }, c.Service = w, y = function (a, b, c, e) {
                d.call(this, a, b, c), this.className = "Service.Method", this.options = e || {}
            }, z = y.prototype = Object.create(d.prototype), z.buildOpt = g.buildOpt, c.Service.Method = y, A = function (a, b, c, d, e, f, g, h) {
            ...
            }, A.prototype = Object.create(y.prototype), c.Service.RPCMethod = A, c
            ...
            return d.isMessage = function (a) {
                    ...
                    for (; b.length > 0;) {
                        if (f = b.shift(), d.isMessage(f)) {
                            if (g = new c.Message(this, this.ptr, f["name"], f["options"], f["isGroup"], f["syntax"]), h = {}, f["oneofs"] && Object.keys(f["oneofs"]).forEach(function (a) {
                                    ...
                                    i.push(a)
                                }), f["extensions"] && (g.extensions = "number" == typeof f["extensions"][0] ? [f["extensions"]] : f["extensions"]), this.ptr.addChild(g), i.length > 0) {
                        ...
                        else if (d.isService(f)) g = new c.Service(this, this.ptr, f["name"], f["options"]), Object.keys(f["rpc"]).forEach(function (a) {
                            var b = f["rpc"][a];
                ...
                if ("string" == typeof c) {
                    ...
                    if (e = c.root, a.Util.IS_NODE && (e = require("path")["resolve"](e)), (e.indexOf("\\") >= 0 || c.file.indexOf("\\") >= 0) && (d = "\\"), g = e + d + c.file, this.files[g] === !0) return this.reset();
                    this.files[g] = !0
                }
                if (b["imports"] && b["imports"].length > 0) {
                    for (i = !1, "object" == typeof c ? (this.importRoot = c["root"], i = !0, h = this.importRoot, c = c["file"], (h.indexOf("\\") >= 0 || c.indexOf("\\") >= 0) && (d = "\\")) : "string" == typeof c ? this.importRoot ? h = this.importRoot : c.indexOf("/") >= 0 ? (h = c.replace(/\/[^\/]*$/, ""), "" === h && (h = "/")) : c.indexOf("\\") >= 0 ? (h = c.replace(/\\[^\\]*$/, ""), d = "\\") : h = "." : h = null, j = 0; j < b["imports"].length; j++)
                        if ("string" == typeof b["imports"][j]) {
                            if (!h) throw Error("cannot determine import root");
                            if (k = b["imports"][j], "google/protobuf/descriptor.proto" === k) continue;
                            if (k = h + d + k, this.files[k] === !0) continue;
                            if (/\.proto$/i.test(k) && !a.DotProto && (k = k.replace(/\.proto$/, ".json")), l = a.Util.fetch(k), null === l) throw Error("failed to import '" + k + "' in '" + c + "': file not found");
                ...
                for (b = "string" == typeof a ? a.split(".") : a, c = this.result, d = 0; d < b.length; d++) {
                    if (!c[b[d]]) {
                        c = null;
                        break
                    }
            ...
            var c = function (a, c) {
                    ...
                    if (this.field = a, this.keyElem = new b.Element(a.keyType, null, !0, a.syntax), this.valueElem = new b.Element(a.type, a.resolvedType, !1, a.syntax), this.map = {}, Object.defineProperty(this, "size", {
                        ...
                        for (d = Object.keys(c), e = 0; e < d.length; e++) f = this.keyElem.valueFromString(d[e]), g = this.valueElem.verifyValue(c[d[e]]), this.map[this.keyElem.valueToString(f)] = {
                            key: f,
                            value: g
                        }
                },
            ...
            if (b && "object" == typeof b ? (d = b, b = null) : b && "function" == typeof b || (b = null), b) return c.Util.fetch("string" == typeof a ? a : a["root"] + "/" + a["file"], function (e) {
                if (null === e) return b(Error("Failed to fetch file")), void 0;
                try {
